...
- TypeScript, Vite, Vitest, Playwright, WebMCP types/evals, and their transitive dependencies are development tooling under the licenses declared by their packages.
