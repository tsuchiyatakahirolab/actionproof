...
|---:|---|---|
| 0–7s | Hero and staging/fake-data/native badges | “The agent did everything right.” [pause] “The result was still wrong.” |
...
| 13–31s | External call fires; selected target, generated contract, schema-bound call, and blocked effect become visible | “Here, the browser agent receives one native, context-matched tool.” [pause] “The visible target becomes the only permitted state delta.” [pause] “Its schema binds the call to Order 1042.” [pause] “The agent invokes it directly through WebMCP.” |
...
| 77–89s | Measured comparison cards | “Official Evals accepted both correct calls.” [pause] “Both collateral effects remained.” [pause] “ExactDelta caught both, without per-record expected-state assertions.” |
